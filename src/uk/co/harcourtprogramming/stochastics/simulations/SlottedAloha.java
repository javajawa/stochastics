package uk.co.harcourtprogramming.stochastics.simulations;

import java.util.Random;
import uk.co.harcourtprogramming.stochastics.entropy.DiscreteProcess;
import uk.co.harcourtprogramming.stochastics.entropy.Distribution;
import uk.co.harcourtprogramming.stochastics.entropy.implementations.Bernoulli;
import uk.co.harcourtprogramming.stochastics.statistics.QueueStatistic;
import uk.co.harcourtprogramming.stochastics.statistics.TimedQueueSample;
...
public class SlottedAloha extends Thread
{
	...
	public void run()
	{
		...
		while (s.sampleCount() < samples)
		{
			...
			retransmissions = Bernoulli.approximatedSample(curr, retransmissionProbability.valueOf(curr), r);
